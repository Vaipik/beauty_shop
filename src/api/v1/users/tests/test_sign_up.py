...
def test_sign_up_with_email(api_client, user_list_url, user_sign_up_email_payload):
...
def test_sign_up_with_phone(api_client, user_list_url, user_sign_up_phone_payload):
